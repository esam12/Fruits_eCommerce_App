...
class AppColors {
  ...
  /// TextFields Colors
  static const Color textFieldBorderColor = Color(0xFFE6E9E9);
  static const Color textFieldFilledColor = Color(0xFFF9FAFA);
  static const Color textFieldHintTextColor = Color(0xFF949D9E);
  static const Color textFieldSuffixIconColor = Color(0xFFC9CECF);
